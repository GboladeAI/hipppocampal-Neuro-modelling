...
def getTotalTimeByRatInMesh(meshID):
    ...
    selectstmt = selectstmt + " a.id = b.id_tblNEURONSPIKE and b.distance < 1   and a.CrossValidation  =0  "
...
def getSpikeCountInMesh(meshID,TimeInMesh):
    ...
    #print data
    ssInsert = "    INSERT INTO NueroSCi.tblTrainNueronSpikeCount_ACtivity (  "
